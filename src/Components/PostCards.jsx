            ...
            {post.comments.map((c) => (
              <div key={c._id} className="space-y-1">
                ...
                <div className="flex items-start space-x-2">
                  <img
                    src={c.author.profilePicture || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"}
                    ...
                    {openReplies[c._id] &&
                      c.reply?.map((r) => (
                        <div key={r._id} className="flex items-start space-x-2 ml-8 mt-1">
                          <img
                            src={r.author.profilePicture || "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png"} 
